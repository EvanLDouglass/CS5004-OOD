...
/**
 * Class Account represents a basic bank account. Accounts cannot be transferred to other people
 * once created (no getters/setters for account holder name).
 *
 * @author evandouglass
 */
public class Account {
  ...
  /**
   * withdraw subtracts the given amount from the current account balance. If the withdraw amount is
   * greater than the account balance, the balance will go to zero.
   *
